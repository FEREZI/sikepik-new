...
<body class="bg-gray-100 p-6">
    <h1 class="text-2xl mb-4">Tambah Driver</h1>
    <form action="{{ route('admin.drivers.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <button type="submit" class="bg-blue-500 text-white py-2 px-4 rounded">Tambah Driver</button>
        <a href="{{ route('admin.drivers.index') }}" class="inline-block bg-red-500 text-white py-2 px-4 rounded hover:bg-gray-400">Kembali</a>
    </form>
</body>
</html>
